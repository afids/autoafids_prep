...
def resample_to_isotropic_resolution(nifti_image_path, isotropic_resolution, output_img):
    """
    Resample a NIfTI MRI image to the specified isotropic resolution.

    Parameters:
    - nifti_image_path: str, path to the NIfTI MRI image file.
    - isotropic_resolution: float, the desired isotropic resolution in mm.
